...
exports.FakeStatusImgForwarded = (from, image, caption) => {
	samu330.sendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '💓𝑆𝐴𝑀 𝑌 𝑃𝐸𝑅𝑅𝑌🔥', "jpegThumbnail": fs.readFileSync(`./NyanBot.jpg`)} } }, caption: '⚡🔥𝒮𝒶𝓂 𝓎 𝒫𝑒𝓇𝓇𝓎 | 𝒩𝓎𝒶𝓃ℬ𝑜𝓉💓', contextInfo: {"forwardingScore": 999, "isForwarded": true} })
}
...
exports.kick = function(from, samu330){
	for (let i of samu330){
		samu330.groupRemove(from, [i])
	}
}

exports.add = function(from, samu330){
	samu330.groupAdd(from, samu330)
}
