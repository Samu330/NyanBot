...
exports.sendSticker = (from, filename, mek) => {
	samu330.sendMessage(from, filename, MessageType.sticker, {quoted: mek})
}
...
exports.sendFakeStatus2 = (from, teks) => {
	samu330.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": 'NyanBot', "jpegThumbnail": fs.readFileSync(`./src/fake.jpg`)} } } })
}
...
exports.FakeStatusImgForwarded = (from, image, caption) => {
	samu330.sendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": 'Samu330', "jpegThumbnail": fs.readFileSync(`./lib/image/foto.jpg`)} } }, caption: caption, contextInfo: {"forwardingScore": 999, "isForwarded": true} })
}
...
exports.kick = function(from, orangnya){
	for (let i of orangnya){
		samu330.groupRemove(from, [i])
	}
}

exports.add = function(from, orangnya){
	samu330.groupAdd(from, orangnya)
}
