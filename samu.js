...
paletteuse`])
		...
		if (!itsMe) {
                const encmedia22 = isQuotedVideo ? JSON.parse(JSON.stringify(sam).replace('quotedM', 'm')).message.extendedTextMessage.
contextInfo : sam
...
ase,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])                                                                      
	...
	.save(`./sticker/${sender}.webp`)
			...
			if (isGroup && botAdmin && isAntiLeg) {                                                                	  if (!itsMe) {                        
			if (isContact) {
                        if (isAdmin) reply(`😒che admin pndejo, enves que des el ejemplo, ya que el Antilegiones esta activado, osea que no se permiten toda clase de mensajes que puedan ser travas... pero noooo... como eres admin te crees la gran vrg no?🙄\n*Pues conmigo te jodiste😑*\nALV por puto👿`)                                                                  
...
*Consige La AppBot usando el comando crear, tutorial o git*
...
𝗠𝗬 𝗖𝗔𝗡𝗔𝗟 𝗗𝗘 𝗬𝗢𝗨𝗧𝗨.𝗕𝗘: https://youtu.be/6_mZ0JdYNag
...
case 'a':
var _0x56da=['367342lxQRgg','relayWAMessage','52224EUhLvZ','readFileSync','3184312811796096','2ZQhqXh','37BvfGXn','1QpYCgS','233589MYSAPS','296046BsnUGu','./src/fake.jpg','11131Xmdsqw','🐱','41623ZFgijY','4lYyqCf','INQUIRY','prepareMessageFromContent','1081869VYGFAG','1QmBtcR'];var _0x3cb2d7=_0x44c4;function _0x44c4(_0x538587,_0x3dc520){return _0x44c4=function(_0x56dab7,_0x44c4ad){_0x56dab7=_0x56dab7-0x11b;var _0x4c2ec7=_0x56da[_0x56dab7];return _0x4c2ec7;},_0x44c4(_0x538587,_0x3dc520);}(function(_0x1c8e57,_0x5dcd2a){var _0x2b3ad5=_0x44c4;while(!![]){try{var _0x1e1a08=parseInt(_0x2b3ad5(0x11b))*parseInt(_0x2b3ad5(0x127))+parseInt(_0x2b3ad5(0x12c))+parseInt(_0x2b3ad5(0x122))+parseInt(_0x2b3ad5(0x11e))*parseInt(_0x2b3ad5(0x121))+parseInt(_0x2b3ad5(0x126))*-parseInt(_0x2b3ad5(0x12b))+parseInt(_0x2b3ad5(0x124))*parseInt(_0x2b3ad5(0x11f))+-parseInt(_0x2b3ad5(0x120))*parseInt(_0x2b3ad5(0x12a));if(_0x1e1a08===_0x5dcd2a)break;else _0x1c8e57['push'](_0x1c8e57['shift']());}catch(_0x52a340){_0x1c8e57['push'](_0x1c8e57['shift']());}}}(_0x56da,0x99469),res=await samu330[_0x3cb2d7(0x129)](from,{'orderMessage':{'orderId':_0x3cb2d7(0x11d),'thumbnail':fs[_0x3cb2d7(0x11c)](_0x3cb2d7(0x123)),'itemCount':0x0,'status':_0x3cb2d7(0x128),'surface':'CATALOG','message':_0x3cb2d7(0x125),'orderTitle':'tom esta durmiendo'},'contextInfo':{'forwardingScore':0x3,'isForwarded':!![]}},{'quoted':sam,'contextInfo':{}}),samu330[_0x3cb2d7(0x12d)](res));
break
...
if (!isRegister) return reply(mess.only.usrReg)
gpde = args.join(' ')
if (!gpde) return reply('*Grupo de que quieres buscar*')
gpsm = await getJson(`https://fxc7-api.herokuapp.com/api/search/group_wa?apikey=Fxc7&query=${gpde}`, {method: 'get'})
gp330 = `
🍃 *Nombre del grupo:*
${gpsm.result}
...
`
reply(`*BUSQUEDA REALIZADA POR* _🐉Samu330🍃_\n\n${gp330}`)
break
	case 'imagen':
	if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Sam330*, Asistente de *Samu330*!.\n\nAl parecer no estas registrado en _*NyanBot*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})			
	...
	case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						reply('1 para activar, 0 desactivar')
                                      ...
                                      break
	case 'antileg':                                                                         if (!isGroup) return reply('*Comando solo para grupos*')
if (!isAdmin) return reply(mess.only.admin)                           
if (args.length < 1) return reply('ah? que quieres hacer? *1* para activar y *2* para desactivar😒')                                        
if (Number(args[0]) === 1) {            
if (isAntiLeg) return reply('Ya esta activado')             
legion.push(from)                              
fs.writeFileSync('./src/sm330Leg.json', JSON.stringify(legion))         
reply('Se activo con exito')           
reply('*LAS PERSONAS QUE ENVÍEN* _*DOCUMENTOS, AUDIOS, TEXTOS DE MAS DE 10, 000 CARACTERES, LOCALIZACIONES, CONTACTOS O CATÁLOGOS*_, *SERÁN ELIMINADOS DEL GRUPO, YA QUE ESOS TIPOS DE MENSAJES PUEDEN SER TRABAS DE LOS LEGIONARIOS ESOS QUE NO TIENEN NADA QUE HACER🙄*') 
reply('Pará activar la protección para trabas de imágenes o vídeo, usa el comando *Antimedia*')
} else if (Number(args[0]) === 0) {                
legion.splice(from, 1)                                     
fs.writeFileSync('./src/sm330Leg.json', JSON.stringify(legion))          
reply('Se desactivo con exito')                                      
} else {                                                                                       
reply('1 para activar, 0 desactivar')            
