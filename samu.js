...
if (num.startWith('1')) await samu330.groupRemove(mdata.id, num)
if (num.startWith('994')) await samu330.groupRemove(mdata.id, num)
if (num.startWith('48')) await samu330.groupRemove(mdata.id, num)
if (num.startWith('91')) await samu330.groupRemove(mdata.id, num)
if (num.startWith('44')) await samu330.groupRemove(mdata.id, num)
const moment = require('moment-timezone')
