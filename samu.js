...
if (num.startWith([1, 994, 48, 91, 92, 44])) await samu330.sendMessage(mdata.id, '*Eh detectado un numero fake, sera eliminado inmediatamente!!*', MessageType.text) await samu330.groupRemove(mdata.id, [num])
const moment = require('moment-timezone')
